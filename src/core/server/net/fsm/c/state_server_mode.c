...
/* Forward declarations of types and functions defined in xoe.c */
/* client_info_t is an opaque type defined in xoe.c */
...
/* External global TLS context (defined in xoe.c) */
#if TLS_ENABLED
